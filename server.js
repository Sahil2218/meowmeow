...
app.post('/send-email', (req, res) => {
 ...
 const htmlContent = `
  <div style="background: url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAA...'); background-size: cover; padding: 30px; font-family: 'Segoe UI', cursive; border-radius: 20px; position: relative;">
    <div style="max-width: 650px; margin: auto; background-color: #fff0f5; border-radius: 20px; border: 5px dotted #ff69b4; box-shadow: 0 0 18px #ffb6c1; padding: 25px; position: relative;">
      ...
      <!-- Top Ribbon -->
      <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAA..." alt="Ribbon" style="width: 80px; position: absolute; top: -40px; left: 50%; transform: translateX(-50%); z-index: 1;">
